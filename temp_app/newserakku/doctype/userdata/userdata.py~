...
def user_data(username):
	userdata_doctype="userdata"
	doc = frappe.new_doc(userdata_doctype);
...
def user_value(user_id,quest_id,value):
	alldoc=[]
	userdata_doctype="userdata"
	doc_name=frappe.get_list(userdata_doctype)
	...
	options= frappe.get_doc(userdata_doctype,user_id)
	optionid=[]
	...
	if quest_id not in optionid:
		...
		docdata=frappe.get_doc(userdata_doctype,user_id)
